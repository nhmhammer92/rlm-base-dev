---
page_id: connect_resources_saved_configuration.htm
title: Saved Configuration (DELETE, PUT)
source_url: https://developer.salesforce.com/docs/atlas.en-us.revenue_lifecycle_management_dev_guide.meta/revenue_lifecycle_management_dev_guide/connect_resources_saved_configuration.htm
release: 262
...
Resource example
:   ```
    https://yourInstance.salesforce.com/services/data/v67.0/connect/cpq/configurator/saved-configuration/5KPxx0025063GSmSAX
    ```
...
:   [Configuration
    Update](./connect_responses_update_favorite_output.htm.md "Output representation of the details of the updated configuration.")
