...
:   [Configuration Set
    Instance](./connect_responses_set_configuration_instance_output.htm.md "Output representation of the details of the context or session that are returned with a set configuration request.")
